        ...
        <div className=' md:mt-6 md:pb-7 md:bg-amber-100 md:hover:bg-lime-100'>
            ...
            <div className='flex md:justify-around flex-col md:flex-row gap-3'>
                ...
                <div className="md:card md:w-96 bg-base-100 shadow-xl">
                    ...
                    <figure><img className='w-full' src="https://images.unsplash.com/photo-1559529648-131cccaaa202?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTcwfHx0b3l8ZW58MHwxfDB8fHww&auto=format&fit=crop&w=500&q=60" alt="Baby Doll" /></figure>
                </div>
            </div>
        </div>
    );
